...
单机 3D 俯视动作刷宝项目。**D1 构筑与装备循环已完成，并于 2026-09-21 通过用户阶段验收；下一阶段为 D2 区域内容与目标掉落。** 当前已接通旋风近战、雷霆旋风、流血横扫、战吼、恢复药剂、随机装备、拆解、重铸、掉落过滤与独立 Hub。正式美术仍为 Godot 几何体占位，D2 的冲锋重击、随机墓园、首领与目标掉落，以及 D3 的发行打磨尚未完成。
