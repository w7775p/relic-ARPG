...
| M1-01 | M1 | 生命、伤害、死亡结算 | M0 | 战斗与角色组件 | 同一死亡仅处理一次 | 未开始 |
| M1-02 | M1 | 普攻、旋风与能量 | M1-01 | 技能运行器 | 移动施放，耗尽停止 | 未开始 |
| M1-03 | M1 | 三类敌人与精英 | M1-01 | 近战、远程、冲锋 | 追击、攻击与死亡 | 未开始 |
| M1-04 | M1 | 雷霆旋风触发链 | M1-02/03 | 暴击闪电、感电爆炸、回复 | 有限触发、范围覆盖和目标去重 | 未开始 |
| M1-05 | M1 | 成型预设与反馈 | M1-04 | 调试装备、音效、特效 | 换预设可感受清怪差异 | 未开始 |
| M1-06 | M1 | 100 敌人压力测试 | M1-05 | 固定负载场景 | 记录设备与帧时间 | 未开始 |
| M2-01 | M2 | 装备定义与实例 | M1 | 底材、词条、装备 ID | 实例独立、合法抽取 | 未开始 |
| M2-02 | M2 | 掉落、拾取与背包 | M2-01 | 战利品、背包、穿脱 | 换装立即影响战斗 | 未开始 |
| M2-03 | M2 | 整备与成长 | M2-02 | 仓库、出售、升级、再次出发 | 完成多趟循环 | 未开始 |
| M2-04 | M2 | 完整探险存档 | M2-01～03 | 状态序列化与恢复 | 装备与探险一致 | 未开始 |
