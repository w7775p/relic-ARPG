...
| 任务 | 内容 | 状态 | 验证 |
| --- | --- | --- | --- |
| [P1_Task1](demo_tasks/P1_Task1.md) | 技能装配、六被动、据点调整与 v3 迁移 | 待验收 | 123 项自动回归通过；可见试玩待完成 |
| [P1_Task2](demo_tasks/P1_Task2.md) | 流血横扫、战吼、恢复药剂与 v4 持续状态存档 | 待验收 | 159 项自动回归通过；Windows 导出与独立启动通过；可见试玩待完成 |
