...
| [P1_Task6](demo_tasks/P1_Task6.md) | D1 过滤、属性解释与阶段验收 | 待执行 | P1_Task1～5 已完成，当前已解锁 |

后续顺序见 [任务总表](demo_tasks/README.md)。当前下一张任务为 P1_Task6。
